...
| 013 | dark-doldrums | which hours will a European power price spike, from the fundamentals that cause it (a Dunkelflaute meeting demand)? | PR-AUC 0.653 on a held-out year vs 0.40 seasonal / 0.39 price-AR baselines; top-1% flagged hours are 91% real spikes; SE3 calm control behaves; five zones, keyless, live EU map | 2026-07-20 | [dark-doldrums](https://github.com/MagicLex/dark-doldrums) |
